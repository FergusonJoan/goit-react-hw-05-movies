  ...
  return (
    <>
      <section className={style.moviecart}>
        <Link
          className={style.moviecart__link_back}
        ...
        <div className={style.moviecart_info}>
          <img
            className={style.moviecart_info__img}
            src={`https://image.tmdb.org/t/p/w300${poster}`}
            alt=""
          />
          <div>
            <h1 className={style.moviecart_info__title}>{title}</h1>
            <p className={style.moviecart_info__score}>
              User Score: {Math.ceil(score * 10)}%
            </p>
        ...
        <div className={style.additional}>
          ...
          <ul className={style.additional__list}>
            <li className={style.additional__item}>
              <Link className={style.additional__link} to="cast">
                Cast
              </Link>
            </li>
            <li className={style.additional__item}>
              <Link className={style.additional__link} to="reviews">
                Reviews
              </Link>
            </li>
          </ul>
